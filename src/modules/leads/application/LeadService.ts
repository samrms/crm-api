...
import type { LeadRepository } from '@/modules/leads/infrastructure/PostgresLeadRepository.js'
import { findTransitionPath } from '@/modules/leads/domain/LeadState.js'
import {
  NotFoundError,
  ValidationError,
  OptimisticLockError,
